...
- Have this application's [API](https://github.com/italocedrosales/gobarber-api) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/italocedrosales/gobarber-web.git && cd gobarber-web
```
...
$ gh repo fork italocedrosales/gobarber-web
```
